...
public class CalendarComboBox extends JComboBox {
	...
	private static final long serialVersionUID = 2335455874300872654L;
	...
	private class MotifDateComboBoxUI extends MotifComboBoxUI {
		private static final long serialVersionUID = 2198206943334080699L;
	...
	private class DatePopup extends BasicComboPopup {
		...
		private static final long serialVersionUID = 4909040125574786019L;
	...
	private class DatePanel extends javax.swing.JPanel {
		...
		private static final long serialVersionUID = -5001068045293387904L;
			...
			for (int i = 0; i < 42; i++) {
				if (i + 1 >= firstDayOfMonth && index <= maximumDayOfMonth) {
					...
					if (index == selectedDay || index == dayOfMonth) {
						...
						if (day[i].getText().equals(String.valueOf(dayOfMonth)))
							dayOfMonthLabel = day[i];
	...
	public void setValue() {
		if (isValidDate(formattedTextField.getText()))
			setSelectedItem(formattedTextField.getText());
		else
	...
	public void updateUI() {
		...
		if (comboBoxUI instanceof WindowsComboBoxUI)
