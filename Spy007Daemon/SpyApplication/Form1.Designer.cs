namespace SpyApplication
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.txCaminho = new System.Windows.Forms.TextBox();
			...
			// txCaminho
			// 
			this.txCaminho.Location = new System.Drawing.Point(28, 44);
			this.txCaminho.Name = "txCaminho";
			this.txCaminho.Size = new System.Drawing.Size(243, 20);
			this.txCaminho.TabIndex = 1;
			this.txCaminho.Text = "c:\\";
			// 
			// button2
			// 
			...
			this.label1.Text = "Digite o Caminho dos Logs";
			// 
			// Form1
			// 
		...
		private System.Windows.Forms.TextBox txCaminho;
